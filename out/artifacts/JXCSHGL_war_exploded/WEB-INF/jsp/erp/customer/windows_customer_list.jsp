...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						<!-- 检索  -->
						<form action="customer/windowsList.do" method="post" name="Form" id="Form">
						...
						<table style="width:100%;">
							<tr>
								<td style="vertical-align:top;">
									<a class="btn btn-mini btn-primary" onclick="choiceCus();">选择</a>
	...
	<script type="text/javascript">
		...
		//选定客户
		function setCustomer(CUSTOMER_ID,NAME){
